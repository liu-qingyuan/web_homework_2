...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到我们水果店', 6000);
    }
    $(".spig").animate({
...
jQuery(document).ready(function ($) {
    $('.nav1 a').mouseover(function () {
        showMessage('快点多了解一下我们吧！！！');
    });
    $('.screen li').mouseover(function () {
        showMessage('要看看我们的新产品吗？');
    });
    ...
    $('.product-fruit-img img').mouseover(function () {
        showMessage('我家的水果特别棒哦！！！');
    });
    $('.row .gradient0').mouseover(function () {
        showMessage('赶紧购买享用哦！！！');
    });
